...
def main():
    with open("input.txt", "r") as f:
        ...
        if check_number_in_range(num):
            print("Задача1.1: Число попадает в заданный диапазон")
            with open("output.txt", "a") as f2:
                f2.write("Задача1.1: Число попадает в заданный диапазон\n")
        else:
            print("Задача1.1: Число не попадает в заданный диапазон")
            with open("output.txt", "a") as f2:
                f2.write("Задача1.1: Число не попадает в заданный диапазон\n")
...
def read_counts(filepath):
    """
    Читает данные из файла и возвращает список количеств шариков.
    """
...
def can_buy_equal_amount(counts):
    """
    Проверяет, можно ли купить ровное количество шариков мороженого.
    """
    total = sum(counts)
    if total % 2 == 0:
        return True
...
counts = read_counts('input.txt')
answer = "да" if can_buy_equal_amount(counts) else "нет"
print(f"\nЗадача3.1: \nМожно ли купить ровное количество шариков мороженого? {answer}")
write_answer('output.txt', answer)
